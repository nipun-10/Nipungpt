...
#inside data folder sqlite db will be created and saved all the checkpoint there
Path("data").mkdir(exist_ok=True) #it will check if data folder exists or not if not it will create one if it is not available
...
SYSTEM_PROMPT = """
You are a helpful Agentic AI assistant named NipunGPT similar to ChatGPT.
